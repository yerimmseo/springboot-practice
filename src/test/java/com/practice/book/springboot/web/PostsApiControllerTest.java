...
// @WebMvcTest의 경우 JPA 기능이 작동하지 않음 (Controller, ControllerAdvice 등 외부 연동과 관련된 부분만 활성화 됨)
// JPA 기능까지 한번에 테스트할 때는 @SpringBootTest, TestRestTemplate를 사용하면 됨
public class PostsApiControllerTest {
    ...
    @Test
    @WithMockUser(roles = "USER") // 인증된 모의(가짜)사용자를 만들어서 사용. roles에 권한 추가
...
//        assertThat(responseEntity.getBody()).isGreaterThan(0L);
        ...
        // WebEnvironment.RANDOM_PORT로 인한 랜덤 포트 실행과 insert 쿼리가 실행된 것 확인
    }
